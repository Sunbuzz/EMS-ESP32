...
MAKE_PSTR_LIST(hpAuxPower, F("hpauxpower"), F("Auxilary power output"))
...
MAKE_PSTR_LIST(hpSwitchValve, F("hpswitchvalve"), F("Switch valve (WW/HC)"))
...
MAKE_PSTR_LIST(hpAuxStage1, F("hpauxstage1"), F("Auxilary stage 1"))
MAKE_PSTR_LIST(hpAuxStage2, F("hpauxstage2"), F("Auxilary stage 2"))
